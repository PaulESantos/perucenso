#' @title get_tab_4_salud
#'
#' @description
#' Esta funcion permite organizar los datos del Cuadro 3  relacionado con el tema de salud
...
#'  SEGUN PROVINCIA, DISTRITO, AREA URBANA Y RURAL, SEXO E IDIOMA O LENGUA MATERNA CON EL QUE
#'  APRENDIO A HABLAR EN SU NINEZ".
#'
...
#' @export
get_tab_4_salud <- function(file, dep_name = NULL){
  df <- readxl::read_xlsx(file,
    ...
    dplyr::rename(primera_lengua = var_1) |>
    dplyr::relocate(primera_lengua, .after = "tipo_seguro") |>
