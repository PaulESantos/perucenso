...
#'
#' @description
#' Esta funcion permite organizar los datos del Cuadro 8 relacionado con el tema de educacion
#' del Tomo VI de los Resultados del Censo Nacional de 2017, el cual tiene el siguiente titulo:
#'
#' "POBLACION CENSADA DE 3 Y MAS ANOS DE EDAD, POR GRUPOS DE EDAD, SEGUN PROVINCIA,
#'  DISTRITO, AREA URBANA Y RURAL, SEXO Y CONDICION DE ALFABETISMO"
#'
#'
#'
...
get_tab_8_edu <- function(file, dep_name = NULL){
  ...
  df <- df |>
    ...
    dplyr::rename( condicion_alfabetismo = var_1) |>
    dplyr::relocate(condicion_alfabetismo, .after = "rango_etareo") |>
