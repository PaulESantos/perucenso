...
#' SEGÚN PROVINCIA, DISTRITO, ÁREA URBANA Y RURAL, SEXO Y RELACIÓN DE PARENTESCO
...
#' @export
get_tab_3_salud <- function(file, dep_name = NULL){
  df <- readxl::read_xlsx(file,
    ...
    dplyr::relocate(parentesco, .after = "tipo_seguro") |>
