...
#'
#' @description
#' Esta funcion permite organizar los datos del Cuadro 7 relacionado con el tema de educacion
...
#' SEGUN LUGAR DE RESIDENCIA DE LA MADRE DENTRO Y FUERA DEL PAIS CUANDO USTED
#'  NACIO"
#'
...
get_tab_7_edu <- function(file, dep_name = NULL){
