...
#'
#' @description
#' Esta funcion permite organizar los datos del Cuadro 5 relacionado con el tema de educacion
...
#' SEGUN LUGAR DE RESIDENCIA PERMANENTE DENTRO Y FUERA DEL PAIS"
#'
#'
...
get_tab_5_edu <- function(file, dep_name = NULL){
